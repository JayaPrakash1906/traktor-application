                              ...
                              return (
                                ...
                                <section className="flex-grow">
                                              ...
                                              <div className="p-[90px;] h-full">
                                                      ...
                                                      <div className=" flex flex-col items-center justify-center p-2 m-12 border font-semibold text-gray-500">
                                                        ...
                                                        <button
                                                          ...
                                                          className="active:scale-[.90] active:duration-70 hover:scale-[1.02] border border-green-300 rounded-md bg-green-500 transition-all ease-in-out md:text-xs font-semibold p-2 m-1  text-gray-500"
                                                          ...
                                                          <span>Apply Now</span>
                                                            ...
                                                            <div className="flex justify-between items-center mb-2">
                                                                <h2 className="text-xl font-semibold text-">About</h2>
                                                                  ...
                                                                  >
                                                                    <FaEye />
                                                                      ...
                                                                      <div className="flex flex-col shadow p-2 m-12 border">
                                                                        ...
                                                                        <div className="flex justify-end p-2 text-lg mx-12">
                                                                          ...
                                                                          <form onSubmit={handleSubmit}>
                                                                            ...
                                                                            <div className="grid grid-cols-8 gap-2">
                                                                              ...
                                                                              <select
                                                                                ...
                                                                                className=" block w-full pl-3 pr-10 py-2 text-base md:h-[45px] border-blue-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
                                                                                placeholder="Gender"
                                                                                name="founder_gender"
                                                                              ...
                                                                              <div className="items-center justify-center">
                                                                                <button className="flex items-center justify-center space-x-4  p-2 "> {/* Flexbox layout for button */}
                                                                                  <FaPlus className="text-green-500"/> <FaTrash className="text-red-500"/> 
                                                                                </button>
