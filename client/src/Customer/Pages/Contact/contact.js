  ...
  return (
    <div className="h-screen flex">
          ...
          <section className="flex-grow">
                        ...
                        <h1 className="text-gray-500 text-3xl font-semibold">Contacts</h1>
                        <div className={`border mt-10 rounded-md w-full`}>
                                        <div className="p-3 font-semibold text-gray-500 text-xl pb-7">All Contacts</div>
                                        <div className="grid grid-cols-2 gap-5 px-10">
                                        <div className="flex justify-between items-center px-3">
                                            <input type="text" placeholder="Search contact" className="w-full rounded-3xl focus:ring-green-400"/></div>
                                                ...
                                                <table class="table-fixed w-full">
                                                        <thead>
                                                                <tr>
                                                                        ...
                                                                        <th className="px-5 py-2 text-left text-green-600">Designation</th>
                                                                        <th className="px-5 py-2 text-left text-green-600">Organisation</th>
                                                                        <th className="px-5 py-2 text-left text-green-600">Contact for</th>
                                                                        <th className="px-5 py-2 text-left text-green-600"></th>
                                                                        
                                                                </tr>
                                                        </thead>
                                                        <tbody>
                                                        <td className="px-5 py-2"><div className="text-gray-500 text-sm font-semibold mt-1 " >Prasth</div></td>
                                                        <td className="px-5 py-2"><div className="text-gray-500 text-sm font-semibold mt-1 " >Tech Support</div></td>
                                                        <td className="px-5 py-2"><div className="text-gray-500 text-sm font-semibold mt-1 " >OIE</div></td>
                                                        <td className="px-5 py-2"><div className="text-gray-500 text-sm font-semibold mt-1 " >9807654123</div></td>
                                                        <td className="px-5 py-2"><button className="text-gray-500 text-sm font-semibold mt-1 p-1 px-3 rounded-xl shadow-md" style={{ backgroundColor: '#afcdde' }}>View</button></td>
                                                                {/* <tr>
                                                                        <td colSpan="5" className="text-center px-5 py-2">
